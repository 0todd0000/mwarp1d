...
**Target audience**: The target audience is anyone working with or analyzing registerable 1D data, especially researchers in the human and animal movement sciences. Full documentation is available in the [project repository](https://github.com/0todd0000/mwarp1d).

# Figures

![Example 1D warp.](figure.png)
